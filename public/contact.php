        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <!--display sent/not sent message -->
                    <p class="text-center bg-info"><?php display_message(); ?></p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <form name="sentMessage" id="contactForm" method="POST">
                    <!--calling the function in the form-->
                    <?php send_message_email(); ?>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="subject" placeholder="Your subject" id="subject" required data-validation-required-message="Please enter your phone number.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
