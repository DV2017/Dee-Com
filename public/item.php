...
//goes down to the end of col-md-9 div
?>
...
<!--Row For Image and Short Description-->
    ...
    <div class="row">
        ...
        <div class="col-md-7">
        <!-- image size 700x600-->
            <img class="img-responsive" src="../ecom_resources/<?php echo set_image_directory($row['product_image']); ?>" alt="">
        </div>
            ...
            <div class="thumbnail">            
                <div class="caption-full">
                    ...
                    <form action="">
                        ...
                        <a href="../ecom_resources/cart.php?add=<?php echo $row['product_id'];?>" class="btn btn-primary">ADD TO CART</a>
                        </div>
                    </form>
                </div>    
            </div><!--thumbnail-->
